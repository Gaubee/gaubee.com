<!--
	...
	2. 展示与正文 GFM heading id 完全一致的二、三级标题。
	3. 在滚动中标记当前阅读位置，并提供可访问的移动 Sheet。
-->
<script lang="ts">
...
{#if toc.length > 0}
  <nav class="hidden lg:block" aria-label="文章目录">
    <div class="sticky top-8 max-h-[calc(100dvh-4rem)] overflow-y-auto pr-2 scrollbar-thin scrollbar-track-transparent">
