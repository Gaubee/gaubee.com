...
<div class="mx-auto max-w-3xl px-4 py-8">
  ...
  <header class="mb-8">
    ...
    <div class="text-muted-foreground mt-4 flex gap-3 text-xs">
      <a href={`/app/github-editor/repo/gaubee/gaubee.com?file=${encodeURIComponent(`src/content/${article.collection}/${article.stem}.md`)}`} class="hover:text-foreground underline">在编辑器打开</a>
