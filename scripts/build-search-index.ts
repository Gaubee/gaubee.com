...
async function generateSearchIndex() {
    ...
    for (const filePath of allFiles) {
        try {
            ...
            if (!data.title || !data.date) {
                console.warn(`Skipping ${filePath}: missing title or date in frontmatter.`);
                continue;
            }
    ...
    console.log(`Search index generated successfully with ${miniSearch.documentCount} documents.`);
